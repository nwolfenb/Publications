...
%% Earth
fn = '..\..\FreezingSimulations\FREZCHEM\v13.3\Seawater\Gitterman';
...
%% MgSO4
fn = '..\..\FreezingSimulations\FREZCHEM\v15.1\MgSO4\MgSO4_1ppt';
[P,T,F1,F2,~] = F1F2F3_FREZCHEM(fn);
T = round(T,1);
...
%% Europa (Cl-Dominated)
fn = '..\..\FreezingSimulations\FREZCHEM\v15.1\Cl_Na_Mg_SO4_seawater\Cl_Na_Mg_SO4_seawater';
[P,T,F1,F2,F3] = F1F2F3_FREZCHEM(fn);
T = round(T,1);
...
fn = '..\..\FreezingSimulations\FREZCHEM\v15.1\SO4_Mg_Na_Cl\SO4_Mg_Na_Cl';
[P,T,F1,F2,F3] = F1F2F3_FREZCHEM(fn);
T = round(T,1);
