% joint_constraints.m
% Generates Figure 6 using data generated by Tb_data.mat for the
% publication
% 
...
ylim([0 30])
clabel(C,h,'manual','Interpreter',interpreter,'FontSize',fontsize,'Color',[0 112 192]/255,...
       'BackgroundColor','w')
hold on
...
[C,h] = contour(y.',x.',delta_Tb.',[10:10:50],'LineWidth',linewidth,'LineColor',[0 112 192]/255);
ylim([0 30])
clabel(C,h,'manual','Interpreter',interpreter,'FontSize',fontsize,'Color',[0 112 192]/255,...
       'BackgroundColor','w')
hold on
...
ax(4).Position(1) = ax(3).Position(1)+ax(3).Position(3)+1.5*margin;
